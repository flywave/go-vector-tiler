...
func (canvas *Canvas) DrawMultiPolygon(mp geom.MultiPolygon, id string, style string, pointStyle string, drawPoints bool) int {
	canvas.Gid(id)
	count := 0
...
func (canvas *Canvas) DrawLine(l geom.LineString, id string, style string, pointStyle string, drawPoints bool) {
	var points []maths.Pt
	pts := l.Subpoints()
...
func (canvas *Canvas) DrawMultiLine(ml geom.MultiLine, id string, style string, pointStyle string, drawPoints bool) {
	canvas.Gid(id)
...
func (canvas *Canvas) DrawGeometry(geo geom.Geometry, id string, style string, pointStyle string, drawPoints bool) int {
	count := 0
	switch g := geo.(type) {
	case geom.MultiLine:
